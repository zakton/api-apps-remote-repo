...
from . import main
from .forms import LoginForm, WeatherForm
...
def weather_app():
    ...
    if form.validate_on_submit():
        ...
        if temp_OK:
            ...
            return render_template('weather_app.html', form=form, city='City Not Found')

    return render_template('weather_app.html', form=form, city=city, temperature=temperature)
